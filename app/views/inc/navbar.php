<nav class="navbar navbar-expand-lg navbar-dark bg-dark w-100">
        <div class="container-fluid">
            <a class="navbar-brand me-auto" href="#">
                <img src="<?php echo APP_URL; ?>/app/views/img/icono.ico" alt="Refugio Los Perrines" height="20px" style="margin-right: 30px;">
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                ...
                <div class="offcanvas-body navbar-dark bg-dark">
                    <ul class="navbar-nav justify-content-center flex-grow-1 pe-3 navbar-dark bg-dark">
                        ...
                        <li class="nav-item">
                            <a class="nav-link mx-lg-2" href="<?php echo APP_URL; ?>nosotros/">¿Quienes somos?</a>
                        </li>
